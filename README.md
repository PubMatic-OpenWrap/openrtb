# openrtb [![GoDoc](https://godoc.org/github.com/PubMatic-OpenWrap/openrtb?status.svg)](https://godoc.org/github.com/PubMatic-OpenWrap/openrtb) [![Build Status](https://travis-ci.org/mxmCherry/openrtb.svg?branch=master)](https://travis-ci.org/mxmCherry/openrtb)
...
This library uses `json.RawMessage` since [v10.0.0](https://github.com/PubMatic-OpenWrap/openrtb/releases/tag/v10.0.0).

# Using

```bash
go get -u "github.com/PubMatic-OpenWrap/openrtb"
```
...
This repo follows [semver](http://semver.org/) - see [releases](https://github.com/PubMatic-OpenWrap/openrtb/releases).
...
## Documentation ([godoc](https://godoc.org/github.com/PubMatic-OpenWrap/openrtb))
